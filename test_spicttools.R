...
ok_group("ffdbdoc_to_spictstock", {
    ...
    ok(cmp_identical(st$obsC, c(100, 110, 120)),
        "Generated obsC, skipping NA entries")

    ok(cmp_identical(st$timeC, c(2000 + (3/12), 2000 + (6/12), 2001)),
    ...
    ok(cmp_identical(st$timeC, seq(2000, 2001.75, by = 0.25)),
...
ok_group("ffdbdoc_to_spictstock:nseasons", {
    ...
    ok(cmp_identical(cs('2000_1 2000_4 2000_7 2000_10 2001_1'), 4),
        "Data has 4 seasons")

    ok(cmp_identical(cs('2000_1 2000_6 2001_1 2001_6'), 2),
        "Data has 2 seasons")

    ok(cmp_identical(cs('2000_1 2001_1 2002_1 2003_1'), 1),
        "Data has 1 season (annual)")

    ok(cmp_identical(cs('2000_1 2000_4 2000_7 2001_1 2001_4 2001_7 2001_10 2002_1'), 4),
